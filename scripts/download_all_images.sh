...
echo ""
echo "For Primary Source Reader images (13 historical documents, paintings,"
echo "cartoons, and photographs for the source analysis pages),"
echo "run:  bash scripts/download_primary_source_images.sh"
